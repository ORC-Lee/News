                ...
                <div class="col-lg-6">
                    ...
                    <form class="form-horizontal" id="singcms-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="description" class="form-control" id="description" placeholder="请填写推荐位描述" value="<?php echo ($position["description"]); ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <input type="radio" name="status" id="optionsRadiosInline2" value="-1" <?php if($position["status"] == -1): ?>checked<?php endif; ?>> 关闭
                            </div>
