			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="singcms-form">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" name="title" class="form-control" id="inputname" placeholder="请填写标题" value="<?php echo ($posContent["title"]); ?>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select class="form-control" name="position_id">
								...
								<?php if(is_array($poss)): foreach($poss as $key=>$pos): ?><option value="<?php echo ($pos["id"]); ?>" <?php if($pos["id"] == $posContent['position_id']): ?>selected="selected"<?php endif; ?> > <?php echo ($pos["name"]); ?></option><?php endforeach; endif; ?>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="url" id="inputPassword3" placeholder="请url地址" value="<?php echo ($posContent["url"]); ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="inputname" class="col-sm-2 control-label">文章id:</label>
						<div class="col-sm-5">
							<input type="text" name="news_id" class="form-control" id="inputname" placeholder="如果和文章无关联的可以不添加文章id" value="<?php echo ($posContent["news_id"]); ?>">
						</div>
					</div>
					<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label">状态:</label>
					<div class="col-sm-5">
						<input type="radio" name="status" id="optionsRadiosInline1" value="1" <?php if($posContent["status"] == 1): ?>checked<?php endif; ?>> 开启
						<input type="radio" name="status" id="optionsRadiosInline2" value="0" <?php if($posContent["status"] == 0): ?>checked<?php endif; ?>> 关闭
					</div>
