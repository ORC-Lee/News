                ...
                <div class="col-lg-6">
                    ...
                    <form class="form-horizontal" id="singcms-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="description" class="form-control" id="description" placeholder="请填写推荐位描述">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <input type="radio" name="status" id="optionsRadiosInline2" value="-1"> 关闭
                            </div>
