            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="catid">
                  ...
                  <?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $key=>$webSite): ?><option value="<?php echo ($webSite["menu_id"]); ?>" <?php if($webSite['menu_id'] == $news['catid']): ?>selected="selected"<?php endif; ?>><?php echo ($webSite["name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
